...
} else setLocalSession(defaultSession);
  ...
  if (confirm('Are you sure you want to end this session?')) {
    ...
    if (getLocalUser().uid == currentSession.adminId) {
      ...
      currentSession.message =
        getLocalUser().displayName + ' has stopped the collaborative session';
      socket.emit('collabSession', currentSession);
...
async function joinSession() {
  ...
  currentNote.mdContent = currentSession.mdContent =
...
function leaveSession() {
  if (confirm('Are you sure you want to leave this session?')) {
    ...
    currentSession.action = 'unsubscribe';
    currentSession.message =
      getLocalUser().displayName + ' has left the session.';
    socket.emit('collabSession', currentSession);
